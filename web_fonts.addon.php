<?php
	...
	if( $called_position == 'before_display_content' ) {
		...
		{
			Context::addJSFile('./addons/web_fonts/fa/js/all.min.Js');
		}
		if( $addon_info->awesome_use== 'enable' ) {
			Context::addCSSFile('///use.fontawesome.com/releases/v6.1.1/js/all.js');
		}
		...
		if( $addon_info->noto_use == 'enable' ) {
			Context::addCSSFile('./addons/web_fonts/css/notosanskor.css');
		}
